...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.bygon.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.bygontools.com", true);
        vSeeds.emplace_back("dnsseed.bygonpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bygontools.com", true);
        vSeeds.emplace_back("seed-b.bygon.loshan.co.uk", true);
