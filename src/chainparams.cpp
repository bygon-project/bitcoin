...
{
    const char* pszTimestamp = "Pos Kota 24/Jan/18 Ditinggal Pergi Tahlilan, Istri Kelonan Sama Tetangga";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1517316198, 264996, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6549c2ae76b313b704c3fd69ddc35b430706e3c2f33fbe9b47832ce4ca2d6a4e"));
        assert(genesis.hashMerkleRoot == uint256S("0xe4f7e2a36878539a741a8a45bdf23f1ed1e7b1a94c2d6375a137c3fd8f95f444"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.emplace_back("18.221.130.251", true);
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc482da2198c5e0512db7cbb13ceba4338da7915c1d2d3e06cf51ae7b9cd44105"));
        assert(genesis.hashMerkleRoot == uint256S("0xe4f7e2a36878539a741a8a45bdf23f1ed1e7b1a94c2d6375a137c3fd8f95f444"));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x20f83a0dc904943df22a90f0eefc82b0e65a3256edbbfe0ea57599497715e311"));
        assert(genesis.hashMerkleRoot == uint256S("0xe4f7e2a36878539a741a8a45bdf23f1ed1e7b1a94c2d6375a137c3fd8f95f444"));
