...
const string strMessageMagic = "Bygon Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Bygon: 1 days
static const int64 nTargetSpacing = 120; // Bygon: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bygon miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Bygon", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbced31d25a94a1549885927ae1f4d931568290219608d122e78d203171ddd16f");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Pos Kota 1/Feb/2018 Suami Bonyok Dihajar Orang Ternyata Usai Kencani Janda";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1517467062; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1517467062;
            block.nNonce   = 776151;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe8ef28cb348e1783bc777ee4fe47f27750d0413966fa870459048b3f977d448b"));
