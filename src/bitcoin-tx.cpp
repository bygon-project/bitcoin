...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bygon-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bygon-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bygon transaction") + "\n" +
              "  bygon-tx [options] -create [commands]   " + _("Create hex-encoded bygon transaction") + "\n" +
              "\n";
